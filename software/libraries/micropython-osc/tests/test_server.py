...
class TestParseMessage(unittest.TestCase):
    ...
    def test_parse_message_midi(self):
        self.assertMessage(
            ("/midi", "m", ((0, 0xB0, 32, 0),)), b"/midi\0\0\0,m\0\0\0\xB0 \0"
        )

    def test_parse_message_rgba(self):
        self.assertMessage(
            ("/rgba", "r", ((128, 32, 32, 255),)), b"/rgba\0\0\0,r\0\0\x80  \xFF"
        )
    ...
    def test_parse_message_combi(self):
        ...
        self.assertEqual((1000, -1, "hello", b"\x00\x01\x02\x03\x04\x05"), args[:-2])
