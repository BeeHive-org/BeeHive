...
class TestCreateMessage(unittest.TestCase):
    ...
    def test_create_message_blob(self):
        self.assertMessage(
            b"/b\0\0,b\0\0\0\0\0\x04\xDE\xAD\xBE\xEF", "/b", b"\xDE\xAD\xBE\xEF"
        )
    ...
    def test_create_message_midi(self):
        self.assertMessage(
            b"/midi\0\0\0,m\0\0\0\xB0 \0", "/midi", ("m", b"\0\xB0\x20\0")
        )

    def test_create_message_midi_fromtuple(self):
        self.assertMessage(
            b"/midi\0\0\0,m\0\0\0\xB0 \0", "/midi", ("m", (0, 0xB0, 32, 0))
        )
    ...
    def test_create_message_midi_frombytearray(self):
        self.assertMessage(
            b"/midi\0\0\0,m\0\0\0\xB0 \0", "/midi", ("m", bytearray([0, 0xB0, 32, 0]))
        )

    def test_create_message_rgba(self):
        self.assertMessage(
            b"/rgba\0\0\0,r\0\0\x80\x20\x20\xFF", "/rgba", ("r", b"\x80\x20\x20\xFF")
        )

    def test_create_message_rgba_fromtuple(self):
        self.assertMessage(
            b"/rgba\0\0\0,r\0\0\x80\x20\x20\xFF", "/rgba", ("r", (128, 32, 32, 255))
        )
...
class TestBundle(unittest.TestCase):
    ...
    data1 = (
        b"#bundle\x00\xd9\xfb\xa5]\xa7\xc1p\x00\x00\x00\x00\x10"
